...
//
// @id = ch.banana.addons.vat_report_austria
// @version = 1.0
// @publisher = Banana.ch SA
// @description = VAT report Austria
// @task = app.command
// @outputformat = none
...
var title = "Umsatzsteuervoranmeldung";
var subTitle = "U 30 PDF";
...
function balanceVerification(openingDate, closureDate, param, report){
	...
	/* Insert the ID between "" (example: getObject(param, "INSERT_ID_HERE").vatAmount; ) */
	/********************************************************************************************/
...
function exec(string) {
	...
	//Create a new report.
	var report = Banana.Report.newReport("vat report austria");
